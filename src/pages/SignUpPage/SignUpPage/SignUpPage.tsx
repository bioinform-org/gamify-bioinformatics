...
import { AuthSocialComponent } from "../../../components/AuthSocialComponent";
...
export const SignUpPage = () => {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    dispatch(
      getTokenFromRegestration({ email, password, username, roles: Role.user })
    );
  };
    ...
    >
      <form className="page-compilator__form" onSubmit={handleSubmit}>
        <label className="page-compilator__label">
          ...
          />
          {isUserNameError && (
            <p className="page-compilator__error-message">{isUserNameError}</p>
          )}
        </label>
        ...
        <label className="page-compilator__label">
          ...
          />
          {isEmailError && (
            <p className="page-compilator__error-message">{isEmailError}</p>
          )}
        </label>
        ...
        <div>
          <label className="page-compilator__label">
            ...
            />
            {isPasswordError && (
              <p className="page-compilator__error-message">
                {isPasswordError}
              </p>
            )}
          </label>
      ...
      <div className="page-compilator__sign-up">
        ...
        <button className="page-compilator__sign-up-button">
          <Link to={"/sign-in"} className="page-compilator__sign-up-link">
            Log In
          </Link>
        </button>
      </div>
